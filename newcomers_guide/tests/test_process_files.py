...
class ProcessMultipleFileTest(TestCase):
    def setUp(self):
        ...
        self.result = process_files.process_all_task_files([[self.english_path, self.content]])
    ...
    def test_handles_unicode_in_title(self):
        ...
        self.result = process_files.process_all_task_files([[self.english_path, a_string()]])
    ...
    def test_clean_up_content_linebreaks(self):
        result = process_files.process_all_task_files([[self.english_path, 'abc \n def']])
    ...
    def test_clean_up_content_links(self):
        result = process_files.process_all_task_files([[self.english_path, 'abc http://example.com def']])
        description = result['To_learn_english']['description']['en']
    ...
    def test_handle_localized_titles_when_processing_the_same_content_in_different_locales(self):
        ...
        result = process_files.process_all_task_files([[self.english_path, a_string()],
    ...
    def test_handle_localized_description_when_processing_the_same_content_in_different_locales(self):
        ...
        result = process_files.process_all_task_files([[self.english_path, english_description],
    ...
    def test_exclude_nontask_content(self):
        ...
        result = process_files.process_all_task_files([[task_path, a_string()], [article_path, a_string()]])
