import logging
from bc211.import_icarol_xml.address import create_address_for_location
from bc211.import_icarol_xml.phone_number import create_phone_numbers_for_location
