...
from qa_tool.viewsets import AlgorithmViewSet, RelevancyScoreViewSet, SearchLocationViewSet, WritableScoreViewSet
...
def build_router():
    ...
    router.register(r'algorithms/(?P<algorithm_id>[\w-]+)/relevancyscores',
                    WritableScoreViewSet, base_name='relevancyscores')
